...
#define SCOPE_REMOTE_FEATURE_IXGBE_SHADOW_RING (1ULL << 5)
#define SCOPE_REMOTE_FEATURE_IXGBE_INLINE   (1ULL << 6)
#define SCOPE_REMOTE_FEATURE_NVME_SHADOW_QUEUE (1ULL << 7)
#define SCOPE_REMOTE_FEATURE_NVME_BAR_PROXY    (1ULL << 8)
...
#define SCOPE_REMOTE_IXGBE_SHADOW_FEATURES \
    (SCOPE_REMOTE_FEATURE_IXGBE_PACKET | \
     SCOPE_REMOTE_FEATURE_IXGBE_SHADOW_RING | \
     SCOPE_REMOTE_FEATURE_IXGBE_INLINE)
#define SCOPE_REMOTE_NVME_SHADOW_BASE_FEATURES \
    (SCOPE_REMOTE_FEATURE_NVME | SCOPE_REMOTE_FEATURE_NVME_SHADOW_QUEUE | \
     SCOPE_REMOTE_FEATURE_NVME_BAR_PROXY | SCOPE_REMOTE_FEATURE_PEER_MR)
#define SCOPE_REMOTE_NVME_SHADOW_STAGING_FEATURES \
    (SCOPE_REMOTE_NVME_SHADOW_BASE_FEATURES | \
     SCOPE_REMOTE_FEATURE_HOST_A_STAGING)
#define SCOPE_REMOTE_NVME_SHADOW_DIRECT_FEATURES \
    (SCOPE_REMOTE_NVME_SHADOW_BASE_FEATURES | \
     SCOPE_REMOTE_FEATURE_ZERO_COPY)
